...
def mail_behavior(db_path) :
    ...
    # 기준 파일과 출력 파일 이름 설정
    criteria_files = {
        str(os.path.join(os.getcwd(), "apps", "analyze", "Upload", "criteria_mail.json")): (os.path.join(directory_path, "mail_grouped_data_with_related_tag_data.json"), os.path.join(directory_path, "output_mail.json")),
        str(os.path.join(os.getcwd(), "apps", "analyze", "Upload","criteria_drive.json")): (os.path.join(directory_path, "drive_grouped_data_with_related_tag_data.json"), os.path.join(directory_path, "output_drive.json")),
        str(os.path.join(os.getcwd(), "apps", "analyze", "Upload","criteria_blog.json")): (os.path.join(directory_path, "blog_grouped_data_with_related_tag_data.json"), os.path.join(directory_path, "output_blog.json"))
    }
    # DB 연결
